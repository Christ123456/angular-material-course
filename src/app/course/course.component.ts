...
export class CourseComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild("MyPaginatorElement") MyPaginator: MatPaginator;
  @ViewChild(MatSort) mySortTable: MatSort;
  ...
  ngAfterViewInit() {
    ...
    this.dataSource.sort = this.mySortTable;
  }
  ...
  toggleAll() {
    if (this.isAllSelected()) {
      ...
      this.selection.setSelection(...this.lessons);
    }
  }
}
